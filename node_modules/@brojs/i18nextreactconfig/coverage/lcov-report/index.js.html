...
<span class="cstat-no" title="statement not covered" >    overrides = await resp.json();</span>
  } catch (error) {
    console.log(error);
  }
  const data2 = await i18nextAxios(url);
&nbsp;
  const override = {
    ...data2.data,
    ...overrides,
...
&nbsp;
export const i18nextReactInitConfig = (<span class="fstat-no" title="function not covered" >i18next) =&gt;</span>
<span class="cstat-no" title="statement not covered" >  i18next</span>
<span class="cstat-no" title="statement not covered" >    .use(HttpApi)</span>
<span class="cstat-no" title="statement not covered" >    .use(initReactI18next)</span>
<span class="cstat-no" title="statement not covered" >    .use(LanguageDetector)</span>
    .init(initConfig);
&nbsp;</pre></td></tr></table></pre>

...
export const mockGetDictionary = (data?: GetDictionaryWordsResponse) => {
      ...
      words: [
        {
          ...
          definition:
            'An approach to artificial intelligence where computers learn from data without being explicitly programmed.',
        ...
        },
        {
          ...
          definition:
            'A mathematical model inspired by the structure and function of biological neural networks, consisting of interconnected nodes organized in layers that can process information.',
        ...
        },
        {
          ...
          definition:
            'A step-by-step procedure or set of instructions for solving a problem or performing a computation.',
        ...
        },
        {
          ...
          definition:
            'An abstract representation of the structure of data, describing how data is organized and related to each other.',
        ...
        },
        {
          ...
          definition:
            'The process of grouping similar objects into clusters so that objects within the same cluster are more similar to each other than to those in other clusters.',
        ...
        },
        {
          ...
          definition:
            'A type of machine learning where the algorithm learns from labeled data, meaning data for which correct answers are known.',
        ...
        },
        {
          ...
          definition:
            'Parameters that define the structure and behavior of a machine learning model, set before the learning process begins.',
  ...
  return spyedGetDictionaryWords;
};

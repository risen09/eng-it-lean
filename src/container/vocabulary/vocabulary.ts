...
export const vocabulary: Array<Word> = [
  {
    id: 1,
    word: 'Tech',
    definition:
      'short for technical, relating to the knowledge, machines, or methods used in science and industry. Tech is a whole industry, which includes IT',
